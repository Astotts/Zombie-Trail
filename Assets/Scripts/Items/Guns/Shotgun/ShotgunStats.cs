...
[CreateAssetMenu(menuName = "Stats/Item/Shotgun", fileName = "New Shotgun Stats")]
public class ShotgunGunStats : ScriptableObject
{
    ...
    [field: SerializeField] public int DamagePerBullet { get; private set; }        // Weapon Damage
    [field: SerializeField] public int BulletsPerShot { get; private set; }         // Number of bullets to spawn on shots
    [field: SerializeField] public int Penetration { get; private set; }            // Zombies to hit before bullet disappear
    ...
    [field: SerializeField] public int Focus { get; private set; }                 // The spread of bullets
    ...
    [field: SerializeField] public int MaxAmmoToHold { get; private set; }          // Unlike other guns shotguns hold ammo separately
    ...
    [field: SerializeField] public float ReloadTime { get; private set; }           // Reload time in seconds for one ammo
