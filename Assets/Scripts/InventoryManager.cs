...
public class InventoryManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Medical
        allItemsInGame.Add(medicalPack);

        // Weapons
        allItemsInGame.Add(weapon_bat);
        allItemsInGame.Add(weapon_piston);
        allItemsInGame.Add(weapon_shotgun);
        allItemsInGame.Add(weapon_assault_rifle);

        // Ammo
        allItemsInGame.Add(items_ammo_pistol);
        allItemsInGame.Add(items_ammo_assault_rifle);
    }
